(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-dom'), require('react-transition-group')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-dom', 'react-transition-group'], factory) :
	(factory((global.ReactAlert = {}),global.React,global.PropTypes,global.ReactDOM,global.ReactTransitionGroup));
}(this, (function (exports,React,PropTypes,ReactDOM,reactTransitionGroup) { 'use strict';
    ...
    createClass(WithAlert, [{
      ...
      value: function render() {
        ...
        return React__default.createElement(
          React.Fragment,
          null,
          React__default.createElement(WrappedComponent, _extends({}, this.props, { alert: alertContainer })),
          ReactDOM.createPortal(React__default.createElement(
            AlertWrapper,
            options,
